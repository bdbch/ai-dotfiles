...
ln -s "$REPO_ROOT/instructions/README.md" "$OPENCODE_DIR/AGENTS.md"
[ -L "$OPENCODE_DIR/instructions" ] && rm "$OPENCODE_DIR/instructions"
ln -s "$REPO_ROOT/instructions" "$OPENCODE_DIR/instructions"
