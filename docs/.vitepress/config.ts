...
export default defineConfig({
  title: 'AI Dotfiles',
  description: 'Personal AI tooling configurations for opencode, Claude, and Codex',
  base: '/ai-dotfiles/',
  cleanUrls: true,
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Configuration', link: '/config/opencode', activeMatch: '/config/' },
      ...
      '/agents/': [
        {
          ...
          items: [
            ...
            { text: 'Architecture Planner', link: '/agents/architecture-planner' },
            ...
            { text: 'Dependency Upgrade Scout', link: '/agents/dependency-upgrade-scout' },
            { text: 'Design Reviewer', link: '/agents/design-reviewer' },
            { text: 'Design Polish Reviewer', link: '/agents/design-polish-reviewer' },
            { text: 'Documentation Writer', link: '/agents/documentation-writer' },
            ...
            { text: 'Performance Investigator', link: '/agents/performance-investigator' },
            ...
            { text: 'TypeScript Type Reviewer', link: '/agents/typescript-type-reviewer' },
      ...
      '/skills/': [
        {
          ...
          items: [
            ...
            { text: 'Accessibility Review', link: '/skills/accessibility-review' },
            { text: 'Browser Debug', link: '/skills/browser-debug' },
            { text: 'Browser Design Review', link: '/skills/browser-design-review' },
