...
| Skill | Description |
|-------|-------------|
| [Accessibility Review](/skills/accessibility-review) | Systematic WCAG 2.1 AA audit using browser tools — keyboard nav, screen reader, color contrast, ARIA |
| [Browser Debug](/skills/browser-debug) | Diagnose console errors, network issues, performance regressions, and accessibility problems via Chrome DevTools |
